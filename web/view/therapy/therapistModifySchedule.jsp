...
<html>
    ...
    <body>
        ...
        <%
            ...
            Boolean isExist = session.getAttribute("isExist") != null ? (Boolean) session.getAttribute("isExist") : false;
            ...
            Map<String, Users> appMap = (Map<String, Users>) session.getAttribute("appMap");
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content" style="background-color: #242424">
                            ...
                            <div class="modal-body">
                                <p>You have added a new time slot.</p>
                            </div>
        ...
        <%
            ...
            %>
                <div class="modal" id="existModal" tabindex="-1">
                    <div class="modal-dialog">
                        <div class="modal-content" style="background-color: #242424">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                <p>Overlapped with existing time slot!</p>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Ok</button>
                            </div>
        ...
        <section id="sect-therapist-dashboard">
            ...
            <div class="center-layout container align-items-center py-5 ">
                ...
                <div class="row justify-content-between">
                    <div class="col-2">
                        <!-- Main Content Area -->
                        <form action="${pageContext.request.contextPath}/AddTimeSlotServlet" method="post" onsubmit="return validateTimeSlot()">
                            <div class="mt-5">Date:</div>
                            <input class="text-dark mt-2 picker" id="date-input" type="date" name="date" required/>
                            <div class="mt-3">Start Time:</div>
                            <select class="mt-2" name="starttime" id="appointment-time" required>
                            ...
                            <div class="mt-3">Session Duration:</div>
                            <select class="mt-2" name="hour" id="appointment-time" required>
                                <option value="1">1 hour</option>
                                <option value="2">2 hour</option>
                                <option value="3">3 hour</option>
                            </select>

                            <div><button type="submit" class="btn-theme mt-4"> Add </button></div>
                        </form>  
                    </div>
                                                    ...
                                                    <%
                                                        ...
                                                        for (LocalDate currentDay : Arrays.asList(monday, tuesday, wednesday, thursday, friday, saturday, sunday)) {
                                                            ...
                                                            for (Timeslot slot : slots) {
                                                                if(!slot.getIsdeleted()){
                                                                    ...
                                                                    if (slotDate.equals(currentDay)) {
                                                                        ...
                                                                        if (starttime.equals(displayTime)) {
                                                                            ...
                                                                            if(slot.getStatus()){
                                                                                out.print("<td class=\"slot available-slot\" rowspan=\"" + rowspan + "\"> <div class=\"slot-status\">Available</div><button class=\"btn btn-danger remove-btn\" data-slotid=\"" + slot.getTimeslotid() + "\"><i class=\"bi bi-trash\"></i></button></td>");
                                                                            }else{
                                                                                
                                                                                String username = appMap.get(slot.getTimeslotid()).getUsername();
                                                                                
                                                                                // Truncate if longer than 12 characters
                                                                                    if (username.length() > 12) {
                                                                                        username = username.substring(0, 9) + "..."; // 9 + 3 = 12 total characters
                                                                                    }
                                                                                out.print("<td class=\"slot booked-slot\" rowspan=\"" + rowspan + "\"> <div class=\"slot-status\">Booked by " + username + "</div></td>");
                                                                            }
                                                              ...
                                                              System.out.println("can print here");

                                                            }   System.out.println("cannot print here");                                                                                                                         
        ...
        <script src="../../js/therapistModifySchedule.js"></script>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                const existModalEl = document.getElementById('existModal');
                if (existModalEl) {
                    const existModal = new bootstrap.Modal(existModalEl);
                    existModal.show();
                }
