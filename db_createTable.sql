...
-- HUAIERN CHECKED /////
CREATE TABLE TAG(
    TAGID            CHAR(8)     NOT NULL,
    TAGNAME          VARCHAR(50) NOT NULL,
    ISCUSTOMISABLE   BOOLEAN     NOT NULL DEFAULT TRUE,
    ISDELETED        BOOLEAN     NOT NULL DEFAULT FALSE,
    PRIMARY KEY(TAGID)
);
...
CREATE TABLE USERTAG(
    USERTAGID   CHAR(8) NOT NULL,
    USERID      CHAR(8) NOT NULL,
    TAGID       CHAR(8) NOT NULL,
    NEWTAGNAME  VARCHAR(50),
    ISDELETED   BOOLEAN NOT NULL DEFAULT FALSE,
...
CREATE TABLE DIARYTAG(
		DIARYTAGID CHAR(8) NOT NULL,
    DIARYID   CHAR(8) NOT NULL,
    USERTAGID CHAR(8),
    TAGID     CHAR(8),
    ISDELETED BOOLEAN NOT NULL DEFAULT FALSE,
    PRIMARY KEY(DIARYTAGID),
    FOREIGN KEY(DIARYID)     REFERENCES DIARYENTRY(DIARYID),
    FOREIGN KEY(USERTAGID)   REFERENCES USERTAG(USERTAGID),
    FOREIGN KEY(TAGID)       REFERENCES TAG(TAGID)
);
